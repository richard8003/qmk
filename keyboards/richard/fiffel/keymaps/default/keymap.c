...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[2] = LAYOUT_split_3x6_3(KC_NO, KC_MPRV, KC_VOLD, KC_MPLY, KC_VOLU, KC_MNXT, KC_UP, KC_RGHT, KC_NO, KC_NO, LGUI(KC_MINS), LGUI(KC_SLSH), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LEFT, LALT(KC_LEFT), KC_NO, LALT(KC_RGHT), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_DOWN, LSA(KC_LEFT), KC_NO, LSA(KC_RGHT), KC_NO, KC_NO, QK_BOOT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO),
	[3] = LAYOUT_split_3x6_3(KC_NO, KC_NO, LGUI(KC_1), LGUI(KC_2), LGUI(KC_3), KC_NO, LCTL(KC_J), LCTL(KC_L), LAG(KC_U), LAG(KC_Y), KC_NO, KC_NO, KC_NO, LALT(KC_U), LALT(KC_ENT), LALT(KC_SPC), LALT(KC_D), KC_NO, LCTL(KC_H), LAG(KC_N), LAG(KC_E), LAG(KC_I), LAG(KC_NO), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, LGUI(KC_K), LCTL(KC_K), LAG(KC_1), LAG(KC_2), LAG(KC_3), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, LAG(KC_SPC), KC_NO),
