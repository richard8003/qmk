...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	// [0] = LAYOUT_split_3x6_3(KC_F3, KC_Q, KC_W, KC_F, KC_P, KC_G, KC_J, KC_L, KC_U, KC_Y, KC_SCLN, KC_LBRC, TD(TD_ESC_CAPS), KC_A, KC_R, KC_S, KC_T, KC_D, KC_H, KC_N, KC_E, KC_I, KC_O, KC_QUOT, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_K, KC_M, KC_COMM, KC_DOT, KC_PSLS, KC_RSFT, LT(3,KC_NO), LT(1,KC_BSPC), LGUI_T(KC_TAB), RCTL_T(KC_ENT), LT(1,KC_SPC), LT(3,KC_NO)),
