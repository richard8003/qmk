...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_split_3x6_3(
        LT(5,KC_F3), KC_Q, KC_W, KC_F, KC_P, KC_G,                 KC_J, KC_L, KC_U, KC_Y, KC_SCLN, KC_LBRC,
        LT(2,KC_ESC), KC_A, KC_R, KC_S, KC_T, KC_D,          KC_H, KC_N, KC_E, KC_I, KC_O, KC_QUOT,
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B,               KC_K, KC_M, KC_COMM, KC_DOT, KC_PSLS, KC_RSFT,
        LM(3, KC_NO), LT(1,KC_BSPC), LGUI_T(KC_TAB),         RCTL_T(KC_ENT), LT(1,KC_SPC), LALT_T(KC_NO)),

	[1] = LAYOUT_split_3x6_3(
        SGUI(KC_X), LALT(KC_7), LALT(KC_2), LSFT(KC_6), LSA(KC_7), LALT(KC_RBRC),     KC_PPLS, KC_7, KC_8, KC_9, LALT(KC_8), LALT(KC_9),
        LCTL(KC_A), KC_EXLM, LSFT(KC_2), KC_HASH, LALT(KC_4), LSFT(KC_5),             KC_PEQL, KC_4, KC_5, KC_6, LSFT(KC_8), LSFT(KC_9),
...
//
	// [5] = LAYOUT_split_3x6_3(
        // KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,    KC_MS_WH_UP, KC_NO, KC_MS_UP, KC_NO, KC_NO, KC_MS_ACCEL0,
        // KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,    KC_MS_WH_DOWN, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT, KC_NO, KC_MS_ACCEL1,
        // KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MS_ACCEL2,
