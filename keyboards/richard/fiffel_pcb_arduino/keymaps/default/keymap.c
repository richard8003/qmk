...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_SCRSHT]   = ACTION_TAP_DANCE_DOUBLE(KC_NO, SGUI(KC_4)),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_split_3x6_3(
                   ...
                   /**---------------------------------------------------------------------**/            /**-------------------------------------------------------------------**/
                      LT(2,KC_NO),        KC_A,     KC_R,     KC_S,      KC_T,      KC_D,                    KC_H,      KC_N,      KC_E,       KC_I,       KC_O,        KC_QUOT,
                   /**---------------------------------------------------------------------**/            /**-------------------------------------------------------------------**/
                      TD(TD_SCRSHT),      KC_Z,     KC_X,     KC_C,      KC_V,      KC_B,                    KC_K,      KC_M,      KC_COMM,    KC_DOT,     KC_PSLS,     KC_NO,
                   /**---------------------------------------------------------------------**/            /**-------------------------------------------------------------------**/
...
/**---------------------------------------------------------------------------------------**/               /**-----------------------------------------------------------------------------------------------**/
   KC_NO,    LALT(KC_7),   RALT(KC_2),   LSFT(KC_6),    LSA(KC_7),        RALT(KC_RBRC),                    KC_PPLS,       KC_7,          KC_8,           KC_9,           KC_NO,       KC_NO,
/**---------------------------------------------------------------------------------------**/               /**-----------------------------------------------------------------------------------------------**/
   KC_NO,    KC_EXLM,      LSFT(KC_2),   KC_HASH,       RALT(KC_4),       LSFT(KC_5),                       KC_PEQL,       KC_4,          KC_5,           KC_6,           KC_NO,       KC_NO,
/**---------------------------------------------------------------------------------------**/                  /**-----------------------------------------------------------------------------------------------**/
   KC_NO,    KC_PLUS,      KC_GRV,       KC_TILD,       LSFT(KC_SLSH),    KC_SLSH,                          KC_PIPE,       KC_1,          KC_2,           KC_3,           KC_NO,        KC_NO,
/**---------------------------------------------------------------------------------------**/               /**--------------------------------------------------------------------------------------------**/
    ...
    // backup
// /**---------------------------------------------------------------------------------------**/               /**-----------------------------------------------------------------------------------------------**/
   // KC_NO,    LALT(KC_7),   RALT(KC_2),   LSFT(KC_6),    LSA(KC_7),        RALT(KC_RBRC),                    KC_PPLS,       KC_7,          KC_8,           KC_9,           LALT(KC_8),       LALT(KC_9),
// /**---------------------------------------------------------------------------------------**/               /**-----------------------------------------------------------------------------------------------**/
   // KC_NO,    KC_EXLM,      LSFT(KC_2),   KC_HASH,       RALT(KC_4),       LSFT(KC_5),                       KC_PEQL,       KC_4,          KC_5,           KC_6,           LSFT(KC_8),       LSFT(KC_9),
// /**---------------------------------------------------------------------------------------**/                  /**-----------------------------------------------------------------------------------------------**/
   // KC_NO,    KC_PLUS,      KC_GRV,       KC_TILD,       LSFT(KC_SLSH),    KC_SLSH,                          KC_PIPE,       KC_1,          KC_2,           KC_3,           RSA(KC_8),        RSA(KC_9),
// /**---------------------------------------------------------------------------------------**/               /**--------------------------------------------------------------------------------------------**/
                                              // KC_NO,         KC_LEFT,          KC_RGHT,                     KC_DOWN,       KC_UP,         KC_0),
                                           // /**--------------------------------------------**/               /**----------------------------------**/
...
//***********************************************************************************************************************************************************************************************************************
	...
	[3] = LAYOUT_split_3x6_3(
                      /*+-----------+-----------+-----------+-----------+-----------+-----------+           +-----------+-----------+-----------+-----------+-----------+-----------+
                        |           |           |           |           |           |           | y = yabai |           |           |   y:nav   |           |           |           |
                        |           |           | desktop 1 | desktop 2 | desktop 3 |           |           |          |          |          | y:toggle  |          |          |
                        |           |           |           |           |           |           |           |           |           |           |  float    |           |           |
                        +-----------+-----------+-----------+-----------+-----------+-----------+           +-----------+-----------+-----------+-----------+-----------+-----------+
                        |           |           |           |           |           |           |           |           |   y:nav   |   y:nav   |   y:nav   |  y:toggle |           |
                        |           |  spotify  | terminal  | browser   |  discord  |           |           |          |          |          |          | full.scrn |           |
                        |           |           |           |           |           |           |           |           |           |           |           |           |           |
                        +-----------+-----------+-----------+-----------+-----------+-----------+           +-----------+-----------+-----------+-----------+-----------+-----------+
                        |           |           |           |           |           |           |           |           | move win  | move win  | move win  |           |           |
                        |           |     󰒮     |     󰝞     |     󰐎     |     󰝝     |     󰒭     |           |           |           |           |           |          |to desktop |to desktop |to desktop |           |           |
                        |           |           |           |           |           |           |           |           |    1      |    2      |    3      |           |           |
                        +-----------+-----------+-----------+-----------+-----------+-----------+           +-----------+-----------+-----------+-----------+-----------+-----------+
                                                            |           |           |           |           |    LT4    |           |           |
                                                            |           |           |           |           |  y:move   |           |           |
                                                            ...
                                                            +-----------+-----------+-----------+           +-----------+-----------+-----------+*/
/**---------------------------------------------------------------------------------------**/                /**--------------------------------------------------------------------------------------------**/
                LT(4,KC_NO),       KC_NO,       LGUI(KC_1),    LGUI(KC_2),   LGUI(KC_3),  KC_NO,                          KC_UP,          KC_RIGHT,     LAG(KC_U),    LAG(KC_Y),  LGUI(KC_SLSH),   LGUI(KC_MINS),
/**---------------------------------------------------------------------------------------**/                /**--------------------------------------------------------------------------------------------**/
                KC_NO,       LALT(KC_U),  LALT(KC_ENT),  LALT(KC_SPC), LALT(KC_D),  LGUI(KC_K),                          KC_LEFT,     LAG(KC_N),      LAG(KC_E),    LAG(KC_I),   LAG(KC_O), KC_NO,
/**---------------------------------------------------------------------------------------**/                /**--------------------------------------------------------------------------------------------**/
                KC_NO, KC_MPRV,     KC_VOLD,     KC_MPLY,     KC_VOLU,     KC_MNXT,                         KC_DOWN,     LAG(KC_1),      LAG(KC_2),    LAG(KC_3),    KC_NO,    KC_NO,
/**---------------------------------------------------------------------------------------**/                /**--------------------------------------------------------------------------------------------**/
                                                         KC_NO, LCTL(LSFT(KC_TAB)), LCTL(KC_TAB),                   LT(4,KC_NO),   LAG(KC_SPC),   LT(4,KC_NO)),
                                                      /**--------------------------------------**/                /**----------------------------------**/
